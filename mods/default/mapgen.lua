...
minetest.register_tool("default:biocheck", {
	...
	on_use = function(itemstack, user, pointed_thing)
		...
		minetest.chat_send_player(user:get_player_name(),
			n .. " " .. minetest.get_heat(pos) .. " " .. minetest.get_humidity(pos))
	end
})
...
default.register_bio({ "semi_desert", 100, 20, grass = "default:desert_sand", dirt = "default:desert_sand", stone =
"default:desert_stone", y_min = -50 })
default.register_bio({ "desert", 100, 0, grass = "default:desert_sand", dirt = "default:desert_sand", stone =
"default:desert_stone", y_min = -50 })
...
default.register_bio({ "cold_coniferous", 20, 20, grass = "default:dirt_with_snow", beach = true, node_water_top =
"default:ice_clear", depth_water_top = 1 })
default.register_bio({ "cold_grassland", 20, 80, grass = "default:dirt_with_snow", beach = true, node_water_top =
"default:ice_clear", depth_water_top = 1 })

default.register_bio({ "tundra_green", 0, 80, grass = "default:dirt_with_permafrost_grass", dirt =
"default:permafrost_dirt", y_min = 20, y_max = 40, beach = true, node_water_top = "default:ice_clear", depth_water_top = 4 })
default.register_bio({ "snowy", 10, 50, grass = "default:dirt_with_snow", depth_filler = 0, node_water_top =
"default:ice_clear", depth_water_top = 4 })
default.register_bio({ "tundra_red", 0, 20, grass = "default:dirt_with_red_permafrost_grass", dirt =
"default:permafrost_dirt", y_min = 20, y_max = 40, beach = true, node_water_top = "default:ice_clear", depth_water_top = 4 })
default.register_bio({ "arctic", 0, 50, grass = "default:snow", stone = "default:ice", dirt = "default:ice", node_water_top =
"default:ice_clear", depth_water_top = 20 })
...
minetest.register_on_generated(function(minp, maxp, seed)
	if minp.y > -30000 and maxp.y < 50 and not minetest.is_protected(maxp, "") then
		...
		local floor = minp.y < 0 and maxp.y > 0 and minetest.get_content_id("default:sand") or
		maxp.y < 0 and minetest.get_content_id("default:stone_spike") or air
	...
	if minp.y > -50 and maxp.y < 50 then
		...
		default.waterland_perlin_map = default.waterland_perlin_map or
		minetest.get_perlin_map(default.water_land_map, { x = lenth, y = lenth, z = lenth })
					...
					if (data[id] == water or data[id] == sand or data[id] == dsand) and y >= height - depth and y <= -6 and den > 0.7 then
						...
						if sandtype == sand and den < 0.8 then
							if heat > 85 and math.random(1, 40) == 1 then
								data[id + area.ystride] = minetest.get_content_id("plants:coral" ..
								math.random(1, 2) .. "_" .. math.random(1, 20))
	...
	if minp.y < 0 and maxp.y > 0 then
		...
		if not default.deepocean_perlin_map then
			default.deepocean_perlin_map = minetest.get_perlin_map(default.deepocean_map, { x = lenth, y = lenth, z =
			lenth })
	...
	if minp.y > 200 and maxp.y < 300 then
		...
		default.cloudland_perlin_map = default.cloudland_perlin_map or
		minetest.get_perlin_map(default.cloud_land_map, { x = lenth, y = lenth, z = lenth })
