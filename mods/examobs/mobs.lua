...
examobs.register_mob({
	name = "magpie",
	textures = {"examobs_bird1.png"},
	mesh = "examobs_bird.b3d",
	type = "animal",
	team = "duck",
	dmg = 1,
	hp = 5,
	...
	collisionbox={-0.3,-0.22,-0.3,0.3,0.15,0.4},
	spawn_on={"group:spreading_dirt_type"},
	on_spawn=function(self)
		examobs.anim(self,"stand")
		self.storage.type=math.random(1,1)
		self.object:set_properties({textures={"examobs_bird" .. self.storage.type .. ".png"}})
	end,
	on_load=function(self)
		self.object:set_properties({textures={"examobs_bird" .. (self.storage.type or 1) .. ".png"}})
