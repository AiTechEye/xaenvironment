...
minetest.register_node("exatec:node_set", {
	...
	on_receive_fields=function(pos, formname, pressed, sender)
		if pressed.save or pressed.setup then
			...
			.."tooltip[save;You can also Mark with /protect 1 /protect 2 to select the area.\nYou do not need to protect, just mark it then press save]"
